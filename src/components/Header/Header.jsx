      ...
      <div className="header">
        ...
        {(menuOpened === false && mobile===true) ? (
          <div 
            ...
            padding:'0.56rem', borderRadius: '5px'}} onClick={() => setMenuOpened(true)}>
            <img src={Bars} alt="" 
            style={{width : "1.5rem", height: "1.5rem"}}/>
          </div>
        ):(<ul className='header-menu'>
        <li><Link onClick={() => setMenuOpened(false)} to='home' activeClass="active" span={true} smooth={true}>Home</Link></li>
